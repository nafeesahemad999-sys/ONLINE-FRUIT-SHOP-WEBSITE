...
$message = $_POST['message'];
	...
	$sql = "INSERT INTO `golden`.`fruit` (`Fname`, `Lname`, `Email`, `Message`) VALUES ('$fname', '$lname', '$email', '$message');";
	// echo $sql;
...
<!DOCTYPE html>
<!--
Template name: Online Fruit Shop
Author: Nafees Bagwan
Date: October, 2022
--------------------------------------------->
<html lang="en">
...
<body>
    ...
    <div class="home">
        ...
        <nav class="navbar">
            <div class="logo">
                <a href="#">GoldenFruit<span></span></a>
            </div>
            ...
            <div class="icon-links">
                ...
                <div id="customer-center" ><a href="#contact"><span class="icon-phone-alt" ></span></a></div>
                <div id="icon-shopping-cart"><span class="icon-cart-arrow-down"><span id="item-counter">0</span></div>
                <div id="login-or-signup" ><span class="icon-user" ><span id="item-counter" >0</span></div>
        ...
        <div id="hero">
            ...
            <p>There are thousands of fruits around the world like apples, mangoes, strawberries, passion, and many more.</p>
            <p>Everyone should eat fruits on a regular basis to stay fit and healthy.</p>
            <div class="button">
                <div class="btn">
            ...
            <div class="featured-product-wrap fruits">
                ...
                <div class="featured-products">
                    <div class="product-wrap apple">
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">160</span>kg
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>kg
                                </ins>
                    ...
                    <div class="product-wrap orange">
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">140</span>kg
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>kg
                                </ins>
                    ...
                    <div class="product-wrap grape">
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">180</span>kg
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>kg
                                </ins>
                    ...
                    <div class="product-wrap">
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">130</span>kg
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>kg
                                </ins>
                    ...
                    <div class="product-wrap pomegranate">
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">180</span>pcs
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>pcs
                                </ins>
                    ...
                    <div class="product-wrap lemon">
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">120</span>kg
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>kg
                                </ins>
                    ...
                    <div class="product-wrap cherry">
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">150</span>kg
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>kg
                                </ins>
                    ...
                    <div class="product-wrap blueberry">
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">100</span>kg
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>kg
                                </ins>
                    ...
                    <div class="product-wrap">
                        ...
                        <div class="product-icons">
                            <div class="add-to-favorite"><span class="icon-heart"></span></div>
                            <p><span class="discount">15</span>% off</p>
                        </div>
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">80</span>pcs
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>pcs
                                </ins>
                    ...
                    <div class="product-wrap">
                        ...
                        <div class="product-description">
                            ...
                            <p class="price">
                                <strong>Price:</strong>
                                <del>
                                    <span class="f-product-price">350</span>pcs
                                </del>
                                <ins>
                                    <span class="f-cur-price">000</span>pcs
                                </ins>
                ...
                <div class="contact-area">
                    <div class="contact-info">
                        ...
                        <div class="contact-address">
                            ...
                            <p>saikalpura malkapur (443101) district buldana maharashtra</p>
                        </div>

                        <div class="contact-mail">
                            <span class="icon-envelope"></span>
                            <p>nafeesahemad999@gmail.com</p>
                        </div>
                    ...
                    <form class="contact-form" action="connect.php" method="post">
                        <div class="name-field">
                            <div class="input-area">
                                <input type="text" id="fname" autocomplete="off" name="fname" required>
                                <label for="fname">First Name</label>
                            </div>

                            <div class="input-area">
                                <input type="text" id="lname" autocomplete="off" name="lname" required>
 ...
 <!----SUFI-->
 <div class="customer-review" id="about">
    <div class="section-wrap">
        <div class="title">
            ...
            <div class="review-content">
                <div class="customer-info">
                    <div class="customer-image">
                        <img src="img/customers/company.jpeg" alt="review1">
                    </div>
                    <div class="customer-details">
                        <h2 class="name">Nafees bagwan</h2>
                        <p class="country">Malkapur</p>
                    </div>
                </div>

                <div class="review-text">
                    <p class="review"><span class="icon-quote-left"></span>launchend in october 2022 golden fruit is india's best online fruit market all types fruit available,
                        fresh and healthy products, world class quality,Welcome to the luxury of golden fruits.The fruits are air flown or shipped regularly from our international partners to our local storage facility, where they are kept at optimum temperature to ensure freshness and the highest of quality when they are delivered to your doorsteps just one day after you order. <span class="icon-quote-right"></span></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="section-wrap">
                <div class="footer-wrap">
                    <div class="company-details">
                        <h2>the fruit company</h2>

                        <div class="fdetails">
                            
                            <p><a href="#Profile">profile</a></p>
                            <p><a href="#Message From The CEO">Message From The CEO</a></p>
                            <p><a href="#How We Workli">How We Workli</a></p>
                            <p><a href="#Import/Export">Import/Export</a></p>
                            <p><a href="#Food Safety Certificates">Food Safety Certificates</a></p>
                        </div>
